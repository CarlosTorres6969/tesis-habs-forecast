...
STEPS = [
    ...
    ("Validacion anidada purgada + seleccion solo en DEV",    "evaluate_nested.py"),
    ("Intervalos de incertidumbre (cobertura CQR)",           "evaluate_intervals.py"),
    ("Modelos de produccion con las features validadas",      "train_final.py"),
    ("Reajuste operativo de isotonia (umbral validado en DEV)", "calibrate_alert.py"),
